...
# Convert to final tensor (num_utterances, seq_length, 1536)
final_tensor = torch.cat(combined_features_list, dim=0)

print(f"Final tensor shape: {final_tensor.shape}")  # Expected: (num_utterances, seq_length, 1536)
